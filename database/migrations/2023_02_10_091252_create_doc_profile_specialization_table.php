...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('doc_profile_specialization', function (Blueprint $table) {
            ...
            $table->primary(['doc_profile_id', 'specialization_id']);
        });
    }
    ...
    {
        Schema::dropIfExists('doc_profile_specialization');
    }
};
